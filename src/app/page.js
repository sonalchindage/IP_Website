        ...
        <div className="container">
          <div className="section-header">
            <h5>
              ...
              your business performance, resilience, and agility. It guides you
              to adopt the best technological solutions and get ready for the
              digital era. By implementing a digital strategy, you can benefit
              from enhanced customer engagement, accelerated business
              development, better management decisions, increased market share,
              and higher revenues.
            </h5>
          ...
          <div className="row gy-4">
            <div className="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
              <div className="service-item position-relative">
                ...
                <p>Define and clarify project goals, scope, and constraints.</p>
              </div>
            </div>
            {/* <!-- End Service Item --> */}
              ...
              <div className="tab-content">
                <div className="tab-pane fade show active" id="tab1">
                  ...
                  <p className="fst-italic">
                    To ensure that your project objectives are well-defined and
                    achievable, we will:
                  </p>
                ...
                <div className="tab-pane fade show" id="tab3">
                  ...
                  <p className="fst-italic">
                    To execute your digital transformation strategy and achieve
                    your desired outcomes, we will:
                  </p>
                  ...
                  <p>
                    any issues or risks that may arise, and communicate with you
                    regularly on the progress and status of the project.
                  </p>
                  ...
                  <p>
                    like dashboards, reports, and meetings to keep you informed
                    and updated on any changes or adjustments that may be
                    needed.
                  </p>
                </div>
                {/* <!-- End Tab 3 Content --> */}
                ...
                <div className="tab-pane fade show" id="tab4">
                  ...
                  <p>
                    the results and outcomes of the project against the success
                    criteria and KPIs that we agreed upon.
                  </p>
              ...
              <div className="content d-flex flex-column justify-content-center h-100">
                ...
                <ul>
                  <li>
                    ...
                    marketing with 10+ years in Technical SEO, Social Media, and
                    Performance Marketing. Worked with diverse industries and
                    used the latest tools and techniques for optimal ROI.
                  </li>
                  <li>
                    <i className="bi bi-check-circle"></i>{" "}
                    <strong>
                    ...
                    Address challenges and opportunities from various angles and
                    deliver value-added outcomes aligned with business goals.
                  </li>
                  <li>
                    <i className="bi bi-check-circle"></i>{" "}
                    <strong>
              ...
              <div className="row gy-4">
                ...
                >
                  ...
                  <p>
                    ...
                    communication experiences. Manage your online reputation and
                    reviews, and handle any crisis or negative feedback.
                  </p>
                </div>
                <div
            ...
            <div className="tab-pane" id="tab-2">
              <div className="row gy-4">
                <div className="col-lg-8 order-1 order-lg-1">
                  ...
                  <p>
                    Use social media, email, mobile, and other digital marketing
                    tools and techniques to build and nurture relationships with
                    your existing customers.
                  </p>
                  <p>
                    Measure and optimize your digital marketing performance and
                    outcomes using analytics and insights.
                  </p>
                  <p>
                    Use performance marketing, our ROAS (Return on Ad Spend) and
                    ROI (Return on Investment) driven strategy, to ensure that
                    you get the best value and results from your digital
                    marketing budget.
                  </p>
                </div>
            ...
            <div className="tab-pane" id="tab-3">
              <div className="row gy-4">
                <div className="col-lg-8 order-2 order-lg-1">
                  ...
                  <p>
                    Manage your inventory, orders, payments, shipping, returns,
                    and customer service using digital solutions and tools.
                  </p>
                  <p>
                    Use digital technologies to enhance your customer experience
                    and satisfaction. Assist traditional business to enable
                    digital commerce or a new brand to start selling on
                    e-commerce directly backed by our go-to-market strategies
            ...
            <div className="tab-pane" id="tab-4">
              <div className="row gy-4">
                <div className="col-lg-8 order-1 order-lg-1">
                  ...
                  <p className="fst-italic">
                    Identify and map out your business processes, analyze their
                    efficiency and effectiveness, and identify the areas that
                    need automation or improvement.
                  </p>
                  <p>
                  ...
                  <p>
                    Assist in the choice of scalable and sustainable technology
                    most suitable for business purpose.
                  </p>
                </div>
                <div className="col-lg-4 order-2 order-lg-2 text-center">
                  <img
            ...
            <div className="tab-pane" id="tab-5">
              <div className="row gy-4">
                <div className="col-lg-8 order-1 order-lg-1">
                  ...
                  <p>
                    <strong>Accelerated business development: </strong>Help you
                    reach new customers, expand into new markets, and develop
                  ...
                  <p>
                    ...
                    yourself from the competition, you can increase your market
            ...
            <div className="tab-pane" id="tab-6">
              <div className="row gy-4">
                <div className="col-lg-8 order-1 order-lg-1">
                  ...
                  <p>
                    <strong>Industry 4.0</strong> readiness to adopt the latest
                    technologies and trends in manufacturing, such as IoT
                    (Internet of Things), cloud computing, big data, etc.
                  </p>
                </div>
                <div className="col-lg-4 order-2 order-lg-2 text-center">
                  <img
            ...
            <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
              ...
              <div className="accordion accordion-flush px-xl-5" id="faqlist">
                ...
                >
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      use digital technology to achieve their goals. Whether you
                      want to improve your online presence, optimize your
                      customer journey, automate your processes, or expand your
                      market reach, digital consulting can help you design and
                      implement effective solutions that fit your needs and
                      budget.
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    <div className="accordion-body">
                      We offer a range of digital services to help businesses of
                      all sizes grow and succeed.
                      <ul>
                        <li>
                          {" "}
                          Brand building and communication: We help you create a
                          strong and consistent brand identity and voice, and
                          communicate effectively with your target audience.
                        </li>
                        <li>
                          {" "}
                          Performance marketing: We help you plan, execute, and
                          measure marketing campaigns that drive traffic,
                          conversions, and ROI.
                        </li>
                        <li>
                          {" "}
                        ...
                        <li>
                          {" "}
                          Strategy consulting: We help you define your business
                          goals and objectives, develop a strategic plan, and
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      <ol>
                        ...
                        <li>
                          Proposal: We present you with a detailed proposal that
                          outlines the scope of work, deliverables, timeline,
                          budget, and terms of agreement. We also provide you
                          with a clear breakdown of the costs and benefits of
                          our services.
                        </li>
                        <li>
                          Execution: We implement the agreed-upon solutions
                          using best practices and standards. We also
                          communicate with you regularly to keep you updated on
                          the progress and status of the project. We also
                          solicit your feedback and input to ensure your
                          satisfaction.
                        </li>
                        <li>
                          Evaluation: We measure the results and outcomes of our
                          services using various metrics and indicators. We also
                ...
                >
                  <h3 className="accordion-header">
                    ...
                    >
                      <i className="bi bi-question-circle question-icon"></i>
                      What are some of the projects that you have done for other
                      clients?
                    </button>
                  </h3>
                  <div
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      <ul>
                        ...
                        <li>
                          {" "}
                          Retail services: eCommerce platform, order management,
                          payment processing, customer support
                        </li>
                        <li>
                          {" "}
                          Food: mobile app, delivery services, payment gateways
                        </li>
                        <li>
                          {" "}
                          Home care: web portal, scheduling, billing, reporting
                        </li>
                        <li>
                          {" "}
